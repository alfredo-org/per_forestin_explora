# Forestín Aventura — prototipo nativo 0.1.2
...
Movimiento actual: [articulaciones y pausa 0.1.2](docs/MOTION_0_1_2.md).

Mejora visual anterior: [paisaje, vegetación y personajes 0.1.1](docs/VISUAL_0_1_1.md).
